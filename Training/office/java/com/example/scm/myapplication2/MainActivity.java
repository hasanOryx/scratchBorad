...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            setTitle("Gallery");
            getLayoutInflater().inflate(R.layout.frament_two, null, false);

        } else if (id == R.id.nav_slideshow) {
            Layout.removeAllViewsInLayout();
            setTitle("Slide Show");
            Layout.addView(getLayoutInflater().inflate(R.layout.frament_one, null, false));

        } else if (id == R.id.nav_manage) {
            Layout.removeAllViewsInLayout();
            setTitle("Manage");
         //   Layout.addView(new Card(this));
            Layout.addView(getLayoutInflater().inflate(R.layout.frament_two, null, false));
